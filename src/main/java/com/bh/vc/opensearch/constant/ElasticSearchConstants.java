package com.bh.vc.opensearch.constant;
...
public class ElasticSearchConstants {
    ...
    public static final String VC_INDEX = "valvcentral";
    public static final String PARTS_DOCUMENT_TYPE = "part";
    public static final String ORDERS_DOCUMENT_TYPE = "order";
